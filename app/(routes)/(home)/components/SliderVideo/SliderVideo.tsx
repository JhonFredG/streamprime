    ...
    <div className="relative w-full -[80vw] md:h-[56.25vw] lg:h-[45vw]">
      ...
      >
        <div className="pt-24 md:pt-0">
          ...
          Descubre una experiencia de entretenimiento sin límites con nuestra aplicación OTT: accede a una vasta colección de series, películas y Tv en vivo, todo en una plataforma intuitiva y de alta definicion, diseñada para satisfacer tus gustos y mantenerte conectado con lo mejor del contenido audiovisual.
          </p>
